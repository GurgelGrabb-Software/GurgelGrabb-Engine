...
namespace gg
{
    ...
    namespace GraphicsUtilities
    {
        ...
        std::shared_ptr<CVertexBuffer> CreateRectangle(float width, float height, const SFloat4& color);
        ...
        template< typename T >
        void SetVertexAttributes(CVertexBuffer& buffer, EAttributeType type, const T& data)
        {
